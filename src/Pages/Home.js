          ...
          { this.mobile ?
            <div>
              <div style={{position: "relative"}}>
                <img style={{maxWidth: '100%', height: 'auto', paddingTop: '5rem'}} src='https://i.imgur.com/dqAtAv6.png' alt=''/>
                <div className="center" style={{paddingTop: '5rem'}}>
            ...
            <Container style={{textAlign: "left", paddingBottom: '4%'}}>
                <Row id="details" className="align-items-center">
                  ...
                  <Col xs={{span: 12, order: 1}} lg={{span: 6, order: 2}}>
                    <div className="p-5">
                      <img data-aos="fade-up" className="rounded img-fluid shadow-lg" src="obscampus.jpg" alt=''/>
                    </div>
                  </Col>
                </Row>
            ...
            <div className='backgroundImage' style={{ backgroundImage: 'url("https://i.imgur.com/dqAtAv6.png")'}}>
              <Container style={{textAlign: "left", paddingBottom: '4%'}}>
                    ...
                    <Row style={{paddingTop: '10%', paddingBottom: '22%', opacity: '0.7'}} data-aos="fade-up">
                      <div className='bounce' style={{color: 'white'}}>
                        <svg style={{width: '3rem', height: '3rem'}} onClick={() => {document.getElementById('details').scrollIntoView({ behavior: 'smooth' })}} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
                      </div>
                    </Row>
                <Row id="details" className="align-items-center">
                  <Col xs={{span: 12, order: 2}} lg={{span: 6, order: 1}}>
